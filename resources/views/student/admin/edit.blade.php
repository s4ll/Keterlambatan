...
<div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
    ...
    @endif
        <div class="mb-5">
          ...
          <input type="text" id="nis" name="nis" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
           focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"required value="{{ $student['nis'] }}">
        </div>
        <div class="mb-5">
          ...
          <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
           focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"required value="{{ $student['name'] }}">
        </div>
        ...
        <div class="mb-4">
          ...
          <div class="relative">
              <select name="rayon_id" id="rayon_id"
                  ...
                  <option value="{{ $rayon['id'] }}" {{ $rayon['id'] == $student['rayon_id'] ? 'selected' : '' }}>{{ $rayon['rayon'] }}</option>
                  @endforeach
              </select>
              <div
        ...
        <div class="mb-4 mt-3">
          ...
          <div class="relative">
              <select name="rombel_id" id="rombel_id"
                  ...
                  <option value="{{ $rombel['id'] }}" {{ $rombel['id'] == $student['rombel_id'] ? 'selected' : '' }}>{{ $rombel['rombel'] }}</option>
                  @endforeach
              </select>
              <div
                  class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
